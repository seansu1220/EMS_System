...
const LOCAL_TOOLS: readonly {
  ...
  },
  {
    ...
    steps: [
      ...
      '另外會產出「到院前未預警清冊」：送醫卻沒有到院前預警的每一件都列出來，並標明分隊有沒有提報扣除。分隊來問「我是哪幾件」時直接開這份，不用重跑。',
    ],
    note: '若有設定「增減試算表」，期間內列在上面的案件會從送醫案件數（分母）扣除。未預警清冊含完整 TEMSIS，放在 tools\\ems-report\\out\\internal\\，不要整份發給分隊。',
  },
  {
